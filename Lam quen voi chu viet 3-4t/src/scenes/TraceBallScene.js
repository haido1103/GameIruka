...
export default class TraceBallScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("bg2", "src/assets/bg_main.jpg")
        this.load.image("panel2", "src/assets/panel2_ui.png")
        this.load.image("ellipse1", "src/assets/Ellipse 1.png")
        this.load.image("ellipse2", "src/assets/Ellipse 2.png")
        ...
        this.load.audio("traceball_audio", "src/assets/audio/trace-ball.mp3")
        this.load.audio("success-color", "src/assets/audio/correct_color.mp3")
