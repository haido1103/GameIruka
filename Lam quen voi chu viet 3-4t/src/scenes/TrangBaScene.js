...
export default class TrangBaScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("mic", "src/assets/mic.png")
        this.load.image("speaker", "src/assets/speaker.png")
        this.load.image("panel3", "src/assets/panel3_ui.png")

        this.load.audio("intro_audio2", "src/assets/audio/cungcogoiten2.mp3")
    ...
    create() {
        ...
        mic.on("pointerdown", async () => {
            ...
            try {
                ...
                const score = submitResp.score ?? submitResp?.result?.score ?? 0
