...
this.load.image("panel","src/assets/panel_ui.png")
this.load.audio("bgm","src/assets/audio/nhacnen.mp3")
this.load.audio("intro_audio","src/assets/audio/cungcogoiten.mp3")
