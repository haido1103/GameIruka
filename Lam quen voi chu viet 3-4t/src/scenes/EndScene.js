...
this.load.image("reset","src/assets/btn_reset.webp")
this.load.image("exit","src/assets/btn_exit.webp")

this.load.audio("vic_sound","src/assets/audio/vic_sound.mp3")
this.load.audio("fireworks","src/assets/audio/fireworks.mp3")
